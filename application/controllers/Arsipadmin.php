...
class Arsipadmin extends CI_Controller {
	...
	public function insertsurat(){
		...
		$this->book_model->insertSurat($idkategori, $nomor, $departemen, $status, $klasifikasi, $dari, $kepada, $nomorsurat, $jenis, $judul, $lampiran, $thn, $tglsurat, $tglmasuk, $lokasi);
	...
	public function usurat(){
		...
		$this->book_model->uSurat($nomor, $departemen, $nomorsurat, $jenis, $dari, $kepada, $judul, $lampiran, $thn, $tglsurat, $tglmasuk, $lokasi);
