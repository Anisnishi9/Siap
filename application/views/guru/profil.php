...
<fieldset style="background-color: rgba(240, 248, 254, 0.6); border-width: 5px; border-color: #0086ad;">
  <legend style="text-align: center; color: #0086ad; font-weight: bold; font-size: 20px; text-transform: uppercase;"><?php echo $role; ?> - PONDOK PESANTREN AL MUAYYAD WINDAN</legend>
<div class="w3-col">
    <div class="w3-third">
