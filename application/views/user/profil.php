...
<fieldset style="background-color: rgba(240, 248, 254, 0.6); border-width: 5px; border-color: #0086ad;">
  <legend style="text-align: center; color: #0086ad; font-weight: bold; font-size: 20px; text-transform: uppercase;"><?php echo $status; ?> - PONDOK PESANTREN AL MUAYYAD WINDAN</legend>
<div class="w3-col">
    <div class="w3-third">
        ...
        <font style="color: #0086ad; font-weight: bold; padding-left: 35px; font-size: 20px;"><?php echo $status; ?></font><br><br>
    ...
    <!--END TITLE-->
 <?php if ($Status == 'Alumni'){ echo "Alumni";} else { echo "
    <div class="w3-col">
      &nbsp;
